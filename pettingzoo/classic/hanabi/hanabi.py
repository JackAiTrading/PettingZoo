...
这个环境模拟了一个合作型卡牌游戏，玩家需要通过有限的信息交流
来共同完成烟花表演，通过策略性地出牌和提供信息来获得高分。
...
这个环境实现了合作型纸牌游戏《汉诺塔》，2-5名玩家通过信息共享和策略配合，
共同完成烟花展示。
...
这个环境实现了合作卡牌游戏"花火"，玩家需要通过合作来完成烟花表演。
游戏的特点是信息不完整，玩家无法看到自己的手牌，需要通过其他玩家的提示来行动。
